...
import type { AddRequestsBatchedOptions, AddRequestsBatchedResult, AutoscaledPoolOptions, CrawlingContext, EnqueueLinksOptions, EventManager, FinalStatistics, GetUserDataFromRequest, ProxyInfo, Request, RequestList, RequestOptions, RequestProvider, RouterHandler, RouterRoutes, Session, SessionPoolOptions, Source, StatisticState } from '@crawlee/core';
import { Dataset, AutoscaledPool, Configuration, SessionPool, Statistics } from '@crawlee/core';
