...
class BasicCrawler {
    ...
    async setStatusMessage(message, options = {}) {
        ...
        await (0, timeout_1.addTimeoutToPromise)(() => client.setStatusMessage(message, options), 1000, 'Setting status message timed out after 1s').catch((e) => this.log.warning(e.message));
    }
    getPeriodicLogger() {
     ...
     */
    async pushData(...args) {
        const dataset = await core_1.Dataset.open(undefined, { config: this.config });
